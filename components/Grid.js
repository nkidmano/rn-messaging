import { Dimensions, FlatList, PixelRatio, StyleSheet } from 'react-nat\
ive';
...
export default class Grid extends React.Component {
  ...
  renderGridItem = info => {
    ...
    // exclude `marginLeft` on the first item of a row
    const marginLeft = index % numColumns === 0 ? 0 : itemMargin;
    // exclude `marginTop` on the first row of the grid
